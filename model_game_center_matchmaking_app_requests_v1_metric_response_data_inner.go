...
// checks if the GameCenterMatchmakingAppRequestsV1MetricResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterMatchmakingAppRequestsV1MetricResponseDataInner{}

// GameCenterMatchmakingAppRequestsV1MetricResponseDataInner struct for GameCenterMatchmakingAppRequestsV1MetricResponseDataInner
type GameCenterMatchmakingAppRequestsV1MetricResponseDataInner struct {
	DataPoints  *GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDataPoints `json:"dataPoints,omitempty"`
	Dimensions  *GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensions `json:"dimensions,omitempty"`
...
func NewGameCenterMatchmakingAppRequestsV1MetricResponseDataInner() *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner {
	this := GameCenterMatchmakingAppRequestsV1MetricResponseDataInner{}
	return &this
}
...
func (o *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner) GetDimensions() GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensions {
	if o == nil || IsNil(o.Dimensions) {
		var ret GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensions
		return ret
	}
	return *o.Dimensions
}
...
// SetDimensions gets a reference to the given GameCenterMatchmakingAppRequestsV1MetricResponseDataInnerDimensions and assigns it to the Dimensions field.
...
func (o GameCenterMatchmakingAppRequestsV1MetricResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GameCenterMatchmakingAppRequestsV1MetricResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner struct {
	value *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner
	isSet bool
}

func (v NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) Get() *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner {
	return v.value
}

func (v *NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) Set(val *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner(val *GameCenterMatchmakingAppRequestsV1MetricResponseDataInner) *NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner {
	return &NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner{value: val, isSet: true}
}

func (v NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterMatchmakingAppRequestsV1MetricResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
