...
// checks if the GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues{}

// GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues struct for GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues
type GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues struct {
	Links *AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks `json:"links,omitempty"`
	Meta *PagingInformation `json:"meta,omitempty"`
	Data []GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueuesDataInner `json:"data,omitempty"`
}
...
func NewGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues() *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues {
	this := GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues{}
	return &this
}
...
func (o *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) GetData() []GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueuesDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueuesDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueuesDataInner and assigns it to the Data field.
...
func (o GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) MarshalJSON() ([]byte, error) {
...
func (o GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues struct {
	value *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues
	isSet bool
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) Get() *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues {
	return v.value
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) Set(val *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues(val *GameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) *NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues {
	return &NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues{value: val, isSet: true}
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsMatchmakingQueues) UnmarshalJSON(src []byte) error {
	v.isSet = true
