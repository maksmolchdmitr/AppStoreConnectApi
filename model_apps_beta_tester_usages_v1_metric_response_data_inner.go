...
// checks if the AppsBetaTesterUsagesV1MetricResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppsBetaTesterUsagesV1MetricResponseDataInner{}

// AppsBetaTesterUsagesV1MetricResponseDataInner struct for AppsBetaTesterUsagesV1MetricResponseDataInner
type AppsBetaTesterUsagesV1MetricResponseDataInner struct {
	DataPoints *AppsBetaTesterUsagesV1MetricResponseDataInnerDataPoints `json:"dataPoints,omitempty"`
	Dimensions *AppsBetaTesterUsagesV1MetricResponseDataInnerDimensions `json:"dimensions,omitempty"`
}
...
func NewAppsBetaTesterUsagesV1MetricResponseDataInner() *AppsBetaTesterUsagesV1MetricResponseDataInner {
	this := AppsBetaTesterUsagesV1MetricResponseDataInner{}
	return &this
}
...
func (o *AppsBetaTesterUsagesV1MetricResponseDataInner) GetDimensions() AppsBetaTesterUsagesV1MetricResponseDataInnerDimensions {
	if o == nil || IsNil(o.Dimensions) {
		var ret AppsBetaTesterUsagesV1MetricResponseDataInnerDimensions
		return ret
	}
	return *o.Dimensions
}
...
// SetDimensions gets a reference to the given AppsBetaTesterUsagesV1MetricResponseDataInnerDimensions and assigns it to the Dimensions field.
...
func (o AppsBetaTesterUsagesV1MetricResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o AppsBetaTesterUsagesV1MetricResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableAppsBetaTesterUsagesV1MetricResponseDataInner struct {
	value *AppsBetaTesterUsagesV1MetricResponseDataInner
	isSet bool
}

func (v NullableAppsBetaTesterUsagesV1MetricResponseDataInner) Get() *AppsBetaTesterUsagesV1MetricResponseDataInner {
	return v.value
}

func (v *NullableAppsBetaTesterUsagesV1MetricResponseDataInner) Set(val *AppsBetaTesterUsagesV1MetricResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsBetaTesterUsagesV1MetricResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsBetaTesterUsagesV1MetricResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsBetaTesterUsagesV1MetricResponseDataInner(val *AppsBetaTesterUsagesV1MetricResponseDataInner) *NullableAppsBetaTesterUsagesV1MetricResponseDataInner {
	return &NullableAppsBetaTesterUsagesV1MetricResponseDataInner{value: val, isSet: true}
}

func (v NullableAppsBetaTesterUsagesV1MetricResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsBetaTesterUsagesV1MetricResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
