...
// checks if the GameCenterMatchmakingRuleSetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterMatchmakingRuleSetResponse{}

// GameCenterMatchmakingRuleSetResponse struct for GameCenterMatchmakingRuleSetResponse
type GameCenterMatchmakingRuleSetResponse struct {
...
func NewGameCenterMatchmakingRuleSetResponse(data GameCenterMatchmakingRuleSet, links DocumentLinks) *GameCenterMatchmakingRuleSetResponse {
	this := GameCenterMatchmakingRuleSetResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o GameCenterMatchmakingRuleSetResponse) MarshalJSON() ([]byte, error) {
...
func (o GameCenterMatchmakingRuleSetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterMatchmakingRuleSetResponse struct {
	value *GameCenterMatchmakingRuleSetResponse
	isSet bool
}

func (v NullableGameCenterMatchmakingRuleSetResponse) Get() *GameCenterMatchmakingRuleSetResponse {
	return v.value
}

func (v *NullableGameCenterMatchmakingRuleSetResponse) Set(val *GameCenterMatchmakingRuleSetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterMatchmakingRuleSetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterMatchmakingRuleSetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterMatchmakingRuleSetResponse(val *GameCenterMatchmakingRuleSetResponse) *NullableGameCenterMatchmakingRuleSetResponse {
	return &NullableGameCenterMatchmakingRuleSetResponse{value: val, isSet: true}
}

func (v NullableGameCenterMatchmakingRuleSetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterMatchmakingRuleSetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
