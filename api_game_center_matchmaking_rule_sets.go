...
func (a *GameCenterMatchmakingRuleSetsAPIService) GameCenterMatchmakingRuleSetsGetCollectionExecute(r ApiGameCenterMatchmakingRuleSetsGetCollectionRequest) (*GameCenterMatchmakingRuleSetsResponse, *http.Response, error) {
	...
	if r.fieldsGameCenterMatchmakingRuleSets != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields[gameCenterMatchmakingRuleSets]", r.fieldsGameCenterMatchmakingRuleSets, "csv")
	}
	if r.limit != nil {
	...
	if r.fieldsGameCenterMatchmakingQueues != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields[gameCenterMatchmakingQueues]", r.fieldsGameCenterMatchmakingQueues, "csv")
	}
	if r.fieldsGameCenterMatchmakingTeams != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields[gameCenterMatchmakingTeams]", r.fieldsGameCenterMatchmakingTeams, "csv")
	}
	if r.fieldsGameCenterMatchmakingRules != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fields[gameCenterMatchmakingRules]", r.fieldsGameCenterMatchmakingRules, "csv")
	}
	if r.limitMatchmakingQueues != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit[matchmakingQueues]", r.limitMatchmakingQueues, "")
	}
	if r.limitRules != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit[rules]", r.limitRules, "")
	}
	if r.limitTeams != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit[teams]", r.limitTeams, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
