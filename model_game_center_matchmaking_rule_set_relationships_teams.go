...
// checks if the GameCenterMatchmakingRuleSetRelationshipsTeams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameCenterMatchmakingRuleSetRelationshipsTeams{}

// GameCenterMatchmakingRuleSetRelationshipsTeams struct for GameCenterMatchmakingRuleSetRelationshipsTeams
type GameCenterMatchmakingRuleSetRelationshipsTeams struct {
	Links *AppAvailabilityV2RelationshipsTerritoryAvailabilitiesLinks `json:"links,omitempty"`
	Meta  *PagingInformation                                          `json:"meta,omitempty"`
	Data  []GameCenterMatchmakingRuleSetRelationshipsTeamsDataInner   `json:"data,omitempty"`
}
...
func NewGameCenterMatchmakingRuleSetRelationshipsTeams() *GameCenterMatchmakingRuleSetRelationshipsTeams {
	this := GameCenterMatchmakingRuleSetRelationshipsTeams{}
	return &this
}
...
func (o *GameCenterMatchmakingRuleSetRelationshipsTeams) GetData() []GameCenterMatchmakingRuleSetRelationshipsTeamsDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GameCenterMatchmakingRuleSetRelationshipsTeamsDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GameCenterMatchmakingRuleSetRelationshipsTeamsDataInner and assigns it to the Data field.
func (o *GameCenterMatchmakingRuleSetRelationshipsTeams) SetData(v []GameCenterMatchmakingRuleSetRelationshipsTeamsDataInner) {
	o.Data = v
}

func (o GameCenterMatchmakingRuleSetRelationshipsTeams) MarshalJSON() ([]byte, error) {
...
func (o GameCenterMatchmakingRuleSetRelationshipsTeams) ToMap() (map[string]interface{}, error) {
...
type NullableGameCenterMatchmakingRuleSetRelationshipsTeams struct {
	value *GameCenterMatchmakingRuleSetRelationshipsTeams
	isSet bool
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsTeams) Get() *GameCenterMatchmakingRuleSetRelationshipsTeams {
	return v.value
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsTeams) Set(val *GameCenterMatchmakingRuleSetRelationshipsTeams) {
	v.value = val
	v.isSet = true
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsTeams) IsSet() bool {
	return v.isSet
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsTeams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameCenterMatchmakingRuleSetRelationshipsTeams(val *GameCenterMatchmakingRuleSetRelationshipsTeams) *NullableGameCenterMatchmakingRuleSetRelationshipsTeams {
	return &NullableGameCenterMatchmakingRuleSetRelationshipsTeams{value: val, isSet: true}
}

func (v NullableGameCenterMatchmakingRuleSetRelationshipsTeams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameCenterMatchmakingRuleSetRelationshipsTeams) UnmarshalJSON(src []byte) error {
	v.isSet = true
